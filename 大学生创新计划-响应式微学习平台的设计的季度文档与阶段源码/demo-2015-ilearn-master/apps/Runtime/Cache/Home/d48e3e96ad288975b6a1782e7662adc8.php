...
<div class="am-g">
  ...
  <br><br><br><br><br><br>
  <h2 style="color:white;">你好！小伙伴,请注册</h2>
<p style="color:white;">今天跬步，明日千里。</p>
    <form class="am-form" action="./isregister" method="post">
      <fieldset class="am-form-set">
      <div class="am-input-group">
  <span class="am-input-group-label"><i class="am-icon-user am-icon-fw"></i></span>
  <input type="text" class="am-form-field" placeholder="用户名" required name="uname">
</div>

<div class="am-input-group">
  <span class="am-input-group-label"><i class="am-icon-lock am-icon-fw"></i></span>
  <input type="password" class="am-form-field" placeholder="密码" required name="pwd1">
</div>

<div class="am-input-group">
  <span class="am-input-group-label"><i class="am-icon-lock am-icon-fw"></i></span>
  <input type="password" class="am-form-field" placeholder="确认密码" required name="pwd2">
</div>

<div class="am-input-group">
  <span class="am-input-group-label"><i class="am-icon-envelope am-icon-fw"></i></span>
  <input type="email" class="am-form-field" placeholder="邮箱" name="email">
</div>
      </fieldset>
      <button type="submit" class="am-btn am-btn-primary am-btn-block">注册</button>
      <br>
      <a href="./login"><button type="button" class="am-btn am-btn-success am-btn-block">登录</button></a>
    </form>
    <br><br><br><br><br><br>
  </div>
</div>
